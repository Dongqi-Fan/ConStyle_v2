...
def parse_options(root_path):
    ...
    if is_train:  # train
        ...
        arch_name = opt['name'] + '_archived_' + time.strftime('%Y%m%d_%H%M%S', time.localtime())
        experiments_root = osp.join(experiments_root, arch_name)
        ...
        arch_name = opt['name'] + '_archived_' + time.strftime('%Y%m%d_%H%M%S', time.localtime())
        results_root = osp.join(results_root, arch_name)
