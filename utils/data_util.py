...
def non_paired_paths_from_folder(folders, keys, filename_tmpl):
    """Generate non paired paths from folders.
    ...
    for gt_path, input_path in zip(gt_paths, input_paths):
        # basename1, _ = osp.splitext(osp.basename(gt_path))
        # basename2, _ = osp.splitext(osp.basename(input_path))
        # print(basename1, basename2)
