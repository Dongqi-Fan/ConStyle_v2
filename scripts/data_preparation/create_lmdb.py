...
def create_lmdb_for_div2k():
    ...
    """
    # HR images
    folder_path = '/home/fandongqi/datasets/deblur/GoPro/train/target_sub'
    lmdb_path = '/home/fandongqi/datasets/deblur/GoPro/train/target_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx3 images
    folder_path = '/home/fandongqi/datasets/deblur/GoPro/train/input_sub'
    lmdb_path = '/home/fandongqi/datasets/deblur/GoPro/train/input_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
